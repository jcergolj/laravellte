...
class PasswordTest extends TestCase
{
    ...
    {
        return [
            'Test new password is required' => ['new_password', ''],
            'Test password must be greater than 7' => ['new_password', '1234567'],
            'Test current Password is required' => ['current_password', ''],
            'Test current Password must match auth user' => ['current_password', 'invalid-password'],
        ];
    }
