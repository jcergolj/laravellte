# Opinionated Laravel based admin panel with merge features from branches approach [![Build Status](https://travis-ci.com/jcergolj/laravellte.svg?branch=master)](https://travis-ci.com/jcergolj/laravellte)
